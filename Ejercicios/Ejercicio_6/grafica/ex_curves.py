...
if __name__ == "__main__":
    ...
    plotCurve(ax, catmullRomCurve, "Catmull-Rom curve", (0, 1, 0))

    # Adding a visualization of the control points
    controlPoints = np.concatenate((P0, P1, P2, P3), axis=1)
    ax.scatter(controlPoints[0,:], controlPoints[1,:], controlPoints[2,:], color=(0,1,0))

    translatedCatmullRom = catmullRomCurve + np.array([0, 1, 0])
    plotCurve(ax, translatedCatmullRom, "Translated Catmull-Rom curve", (0, 1, 1))
