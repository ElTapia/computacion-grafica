...
class ModelMovement:
    ...
    def __init__(self):
        # Contiene movimientos de cada parte
...
class RightArmMovement(AbstractPart):
    ...
    def set_points_theta_z(self):
        ...
        # puntos mov brazo derecho en eje z
        P0 = np.array([[-1,     0,         0]]).T
        P1 = np.array([[ 0,     0,         0]]).T
...
class CompleteRightArmMovement(AbstractPart):
    ...
    def set_points_theta_x(self):
        ...
        # puntos mov brazo derecho completo en eje x
        P0 = np.array([[ -1,     0,          0]]).T
        P1 = np.array([[  0,     0,          0]]).T
        P2 = np.array([[  4,     0,          0]]).T
    ...
    def set_points_theta_y(self):
        ...
        # puntos mov brazo derecho completo en eje y
        P0 = np.array([[-1,     0,           0]]).T
        P1 = np.array([[ 0,     0,           0]]).T
        P2 = np.array([[ 1,     np.pi/2,     0]]).T
    ...
    def set_points_theta_z(self):
        ...
        # puntos mov brazo derecho completo en eje z
        P0 = np.array([[-1,     0,   0]]).T
        P1 = np.array([[ 0,     0,   0]]).T
...
class LeftArmMovement(AbstractPart):
    ...
    def set_points_theta_x(self):
        ...
        # puntos mov brazo izquierdo en eje x
        P0 = np.array([[-1,     0,           0]]).T
        P1 = np.array([[ 0,     0,           0]]).T
        P2 = np.array([[ 6,     0,           0]]).T
    ...
    def set_points_theta_y(self):
        ...
        # puntos mov brazo izquierdo en eje y
        P0 = np.array([[ -1,    0,          0]]).T
        P1 = np.array([[ 0,     0,          0]]).T
        P2 = np.array([[ 1,     0,          0]]).T
...
class CompleteLeftArmMovement(AbstractPart):
    ...
    def set_points_theta_x(self):
        ...
        # puntos mov brazo izquierdo completo en eje x
        P0 = np.array([[ -1,     0,           0]]).T
        P1 = np.array([[  0,     0,           0]]).T
        P2 = np.array([[  5,     0,           0]]).T
    ...
    def set_points_theta_y(self):
        ...
        # puntos mov brazo izquierdo completo en eje y
        P0 = np.array([[-1,     0,              0]]).T
        P1 = np.array([[ 0,     0,              0]]).T
        P2 = np.array([[ 1,     -np.pi/2,       0]]).T
        P3 = np.array([[ 2,     -np.pi/2.2,     0]]).T
    ...
    def set_points_theta_z(self):
        ...
        # puntos mov brazo izquierdo completo en eje z
        P0 = np.array([[-1,     0,   0]]).T
        P1 = np.array([[ 0,     0,   0]]).T
        P2 = np.array([[ 10,    0,   0]]).T
        P3 = np.array([[ 11,    0,   0]]).T
...
class RightLegMovement(AbstractPart):
    ...
    def set_points_theta_x(self):
        ...
        # puntos mov pierna derecha en eje yx
        P0 = np.array([[-1,     0,            0]]).T
        P1 = np.array([[ 0,     0,            0]]).T
    ...
    def set_points_theta_y(self):
        ...
        # puntos mov pierna derecha en eje y
        P0 = np.array([[-1,     0,            0]]).T
        P1 = np.array([[ 0,     0,            0]]).T
    ...
    def set_points_theta_z(self):
        ...
        # puntos mov pierna derecha en eje z
        P0 = np.array([[-1,     0,   0]]).T
        P1 = np.array([[ 0,     0,   0]]).T
        P2 = np.array([[ 10,    0,   0]]).T
        P3 = np.array([[ 11,    0,   0]]).T
...
class RightFootMovement(AbstractPart):
    ...
    def set_points_theta_x(self):
        ...
        # puntos mov pie derecho en eje x
        P0 = np.array([[ -1,     0,           0]]).T
        P1 = np.array([[  0,     0,           0]]).T
        P2 = np.array([[  4.5,   0,           0]]).T
        P3 = np.array([[  5,     np.pi/1.2,   0]]).T
    ...
    def set_points_theta_y(self):
        ...
        # puntos mov pie derecho en eje y
        P0 = np.array([[ -1,     0,            0]]).T
        P1 = np.array([[  0,     0,            0]]).T
        P2 = np.array([[  1,     -np.pi/1.2,   0]]).T
        P3 = np.array([[  1.5,   0,            0]]).T
    ...
    def set_points_theta_z(self):
        ...
        # puntos mov pie derecho en eje z
        P0 = np.array([[ -1,     0,            0]]).T
        P1 = np.array([[  0,     0,            0]]).T
        P2 = np.array([[  1,     -np.pi/2,   0]]).T
        P3 = np.array([[  1.5,   0,            0]]).T
...
class LeftLegMovement(AbstractPart):
    ...
    def set_points_theta_x(self):
        ...
        # puntos mov pierna izquierda en eje x
        P0 = np.array([[ -1,     0,            0]]).T
        P1 = np.array([[  0,     0,            0]]).T
        P2 = np.array([[  1,     0,            0]]).T
    ...
    def set_points_theta_y(self):
        ...
        # puntos mov pierna izquierda en eje y
        P0 = np.array([[ -1,     0,            0]]).T
        P1 = np.array([[  0,     0,            0]]).T
        P2 = np.array([[  1,     0,            0]]).T
    ...
    def set_points_theta_z(self):
        ...
        # puntos mov pierna izquierda en eje z
        P0 = np.array([[-1,     0,   0]]).T
        P1 = np.array([[ 0,     0,   0]]).T
        P2 = np.array([[ 10,    0,   0]]).T
        P3 = np.array([[ 11,    0,   0]]).T
...
class LeftFootMovement(AbstractPart):
    ...
    def set_points_theta_x(self):
        ...
        # puntos mov pie izquierdo en eje x
        P0 = np.array([[ -1,     0,            0]]).T
        P1 = np.array([[  0,     0,            0]]).T
        P2 = np.array([[  5,     0,            0]]).T
    ...
    def set_points_theta_y(self):
        ...
        # puntos mov pie izquierdo en eje y
        P0 = np.array([[ -1,     0,            0]]).T
        P1 = np.array([[  0,     0,            0]]).T
        P2 = np.array([[  1,     0,            0]]).T
        P3 = np.array([[  1.5,   np.pi/1.2,    0]]).T
    ...
    def set_points_theta_z(self):
        ...
        # puntos mov pie izquierdo en eje z
        P0 = np.array([[ -1,     0,            0]]).T
        P1 = np.array([[  0,     0,            0]]).T
        P2 = np.array([[  1,     0,            0]]).T
...
class CompleteModel():
    ...
    def set_points(self):
        ...
        # puntos mov cuerpo completo en eje z
        P0 = np.array([[ -1,     0,    0]]).T
        P1 = np.array([[  0,     0,    0]]).T
        P2 = np.array([[  1,     0,    0]]).T
...
class HeadMovement():
    ...
    def set_points(self):
        ...
        # puntos mov rotacion cabeza en eje z
        P0 = np.array([[-1,     0,            0]]).T
        P1 = np.array([[ 0,     0,            0]]).T
        P2 = np.array([[ 1,     0,            0]]).T
...
class CamMovement():
    ...
    def set_points(self):
        z_translate = 0.35
        scale = 50
        # Puntos curva movimiento de cámara
...
class lightMovement():
    ...
    def set_points(self):
        ...
        max_pos = 20.0
        min_pos = -20.0
        # Puntos curva movimiento de luces
